...
def get_matches(date, con=conn):
    ...
    com1 = "select tourney_date, winner_id, loser_id, match_score from atp_match"
    com2 = "where tourney_date>='{date}'".format(date=date)
    com3 = "and tourney_date<'{date}'".format(date=next_date)
    com4 = "and tourney_name not like '%Davis Cup%'"
    com5 = "and tourney_name not like '%Laver Cup%'"
    ...
    com = " ".join([com1, com2, com3, com4, com5])
...
def main():
    ...
    df.to_csv("atp_ratings.csv", index=False, header=headers)
